...
app.post('/jokes', (req, res) => {
  ...
  let newObject = {id: newId, jokeText: newText, jokeType: newType };
  jokes.push(newObject);
  res.json(newObject);
});
...
app.put('/jokes/:id', (req, res) => {
  ...
  //ovde je moralo biti const, var nije radilo
  const remadeJoke = {id: id, jokeText: newText, jokeType: newType };
  const jokeIndex = jokes.findIndex((joke) => joke.id === id);

  jokes[jokeIndex] = remadeJoke;
